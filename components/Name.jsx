...
import NameStyle from '../styles/name.style'
                    ...
                    <motion.div className="name-wrapper"> 
                        ...
                        {(router.route === "/" || router.route === "/cv") && (
                            <div className="name-info">
                                ...
                                >lives and works in {art.artistInfo.workCities[0]} {art.artistInfo.workCities[1] !== undefined && `and ${art.artistInfo.workCities[1]}`} {art.artistInfo.workCities[2]!== undefined && ` and ${art.artistInfo.workCities[2]}`}
                                </motion.h5>
                            </div>
                        )}
                        ...
                        {router.route === "/" && (
                            <div className="name-links-container">
                                <a className="name-instagram" href="https://www.instagram.com/bernardbolter" alt="Bernard Bolter's Instagram">
                                    <div className="name-arrow">
                                        <span className="name-top" />
                                        <span className="name-shaft" />
                                        <span className="name-bottom" />
                                    </div>
                                    <svg className="name-insta-svg" viewBox="0 0 17 17" fill="none">
                                ...
                                >
                                    <svg className="name-link-svg" viewBox="0 0 21 21">
                                            ...
                                            >
                                                {art.artistInfo.links.map(link => {
                                                    ...
                                                    <motion.a 
                                                        ...
                                                        className="name-link"
                                                    >
                                                        <div className="name-link-arrow">
                                                            <span className="name-link-top" />
                                                            <span className="name-link-shaft" />
                                                            <span className="name-link-bottom" />
                                                        </div>
                                                        <p className="name-link-text">{link.title}</p>
                                                    </motion.a>
                                                )})}
                                            </motion.div>
                                        )}
